...
const GENERAL_SETTINGS_REPLACEMENT_26623 = (
  ...
  [
    `function ${functionName}(){let e=(0,${cacheNamespace}.c)(17),t=${settingsStateFunction}(${settingsStateArg}),{platform:n}=${platformHook}(),r=n!==\`windows\`,i=${intlHook}(),a=${settingsRead}(${settingsNamespace}.preventSleepWhileRunning),codexfastDisableAutomaticUpdates=${settingsRead}(${settingsNamespace}.disableAutomaticUpdates);if(!r)return null;let o,s;e[0]===Symbol.for(\`react.memo_cache_sentinel\`)?(o=(0,${jsxNamespace}.jsx)(${messageComponent},{...${messagesNamespace}.preventSleepWhileRunning}),s=(0,${jsxNamespace}.jsx)(${messageComponent},{id:\`settings.general.power.preventSleepWhileRunning.description\`,defaultMessage:\`Keep your computer awake while Codex is running a chat\`,description:\`Description for preventing sleep while a chat runs\`}),e[0]=o,e[1]=s):(o=e[0],s=e[1]);let codexfastPreventSleepChecked=a??!1,codexfastPreventSleepOnChange;e[2]===t?codexfastPreventSleepOnChange=e[3]:(codexfastPreventSleepOnChange=e=>{${settingsWrite}(t,${settingsNamespace}.preventSleepWhileRunning,e)},e[2]=t,e[3]=codexfastPreventSleepOnChange);let codexfastPreventSleepAria;e[4]===i?codexfastPreventSleepAria=e[5]:(codexfastPreventSleepAria=i.formatMessage(${messagesNamespace}.preventSleepWhileRunning),e[4]=i,e[5]=codexfastPreventSleepAria);let codexfastPreventSleepRow;e[6]!==codexfastPreventSleepChecked||e[7]!==codexfastPreventSleepOnChange||e[8]!==codexfastPreventSleepAria?(codexfastPreventSleepRow=(0,${jsxNamespace}.jsx)(${rowComponent},{label:o,description:s,control:(0,${jsxNamespace}.jsx)(${toggleComponent},{checked:codexfastPreventSleepChecked,onChange:codexfastPreventSleepOnChange,ariaLabel:codexfastPreventSleepAria})}),e[6]=codexfastPreventSleepChecked,e[7]=codexfastPreventSleepOnChange,e[8]=codexfastPreventSleepAria,e[9]=codexfastPreventSleepRow):codexfastPreventSleepRow=e[9];`,
    "let codexfastUpdateLocale=(i.locale??globalThis.navigator?.language??``).toLowerCase(),codexfastUpdateMessages=codexfastUpdateLocale.startsWith(`zh-cn`)||codexfastUpdateLocale.startsWith(`zh-hans`)?{label:`停用自动更新`,description:`停止后续后台更新检查，但不影响手动“检查更新”。`}:codexfastUpdateLocale.startsWith(`zh-tw`)||codexfastUpdateLocale.startsWith(`zh-hk`)||codexfastUpdateLocale.startsWith(`zh-hant`)?{label:`停用自動更新`,description:`停止後續背景更新檢查，但不影響手動「檢查更新」。`}:codexfastUpdateLocale.startsWith(`ja`)?{label:`自動更新を無効にする`,description:`今後のバックグラウンド更新チェックを停止します。手動の「アップデートを確認」は無効になりません。`}:codexfastUpdateLocale.startsWith(`ko`)?{label:`자동 업데이트 비활성화`,description:`수동 업데이트 확인은 유지하면서 이후 백그라운드 업데이트 확인을 중지합니다.`}:codexfastUpdateLocale.startsWith(`fr`)?{label:`Désactiver les mises à jour automatiques`,description:`Arrête les prochaines recherches de mises à jour en arrière-plan sans désactiver la recherche manuelle.`}:codexfastUpdateLocale.startsWith(`de`)?{label:`Automatische Updates deaktivieren`,description:`Stoppt künftige Hintergrundprüfungen auf Updates, ohne die manuelle Suche nach Updates zu deaktivieren.`}:codexfastUpdateLocale.startsWith(`es`)?{label:`Desactivar actualizaciones automáticas`,description:`Detiene las futuras comprobaciones de actualizaciones en segundo plano sin desactivar la búsqueda manual.`}:codexfastUpdateLocale.startsWith(`pt`)?{label:`Desativar atualizações automáticas`,description:`Interrompe futuras verificações de atualização em segundo plano sem desativar a verificação manual.`}:codexfastUpdateLocale.startsWith(`it`)?{label:`Disattiva aggiornamenti automatici`,description:`Interrompe i futuri controlli degli aggiornamenti in background senza disattivare il controllo manuale.`}:codexfastUpdateLocale.startsWith(`ru`)?{label:`Отключить автоматические обновления`,description:`Останавливает последующие фоновые проверки обновлений, не отключая ручную проверку.`}:{label:`Disable automatic updates`,description:`Stop future background update checks without disabling manual Check for Updates.`};",
    `let codexfastUpdateChecked=codexfastDisableAutomaticUpdates??!1,codexfastUpdateOnChange;e[10]===t?codexfastUpdateOnChange=e[11]:(codexfastUpdateOnChange=e=>{${settingsWrite}(t,${settingsNamespace}.disableAutomaticUpdates,e)},e[10]=t,e[11]=codexfastUpdateOnChange);let codexfastUpdateRow;return e[12]!==codexfastUpdateChecked||e[13]!==codexfastUpdateOnChange||e[14]!==codexfastUpdateMessages.label||e[15]!==codexfastUpdateMessages.description?(codexfastUpdateRow=(0,${jsxNamespace}.jsx)(${rowComponent},{label:codexfastUpdateMessages.label,description:codexfastUpdateMessages.description,control:(0,${jsxNamespace}.jsx)(${toggleComponent},{checked:codexfastUpdateChecked,onChange:codexfastUpdateOnChange,ariaLabel:codexfastUpdateMessages.label})}),e[12]=codexfastUpdateChecked,e[13]=codexfastUpdateOnChange,e[14]=codexfastUpdateMessages.label,e[15]=codexfastUpdateMessages.description,e[16]=codexfastUpdateRow):codexfastUpdateRow=e[16],(0,${jsxNamespace}.jsxs)(${jsxNamespace}.Fragment,{children:[codexfastPreventSleepRow,codexfastUpdateRow]})}`,
  ].join("");
