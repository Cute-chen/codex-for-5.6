...
function runApplyRestoreCase(caseConfig: ApplyRestoreCaseConfig): void {
...
function main(): void {
  ...
  const applyRestoreMatrix: ApplyRestoreCaseConfig[] = [
    {
  ...
  for (const caseConfig of applyRestoreMatrix) {
    runApplyRestoreCase(caseConfig);
  }
