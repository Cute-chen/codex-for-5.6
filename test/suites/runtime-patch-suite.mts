...
export function runRuntimePatchSuite(): void {
  ...
  assertContains(serviceTierConversationFallbackNullishResult.content, "t=D.serviceTier", "expected nullish stale conversation state to fall back to the configured default tier");
