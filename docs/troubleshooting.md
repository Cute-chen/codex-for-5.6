...
- On `26.623.31443` (`build 4441`), `26.623.31921` (`build 4452`), `26.623.42026` (`build 4514`), `26.623.61825` (`build 4548`), `26.623.70822` (`build 4559`), and `26.623.81905` (`build 4598`), codexfast skips Plugins runtime targets because Plugins is supported by the official app path for this repo's target use case. For those builds, inspect upstream plugin state or connector behavior before looking for codexfast Plugins patch misses.
